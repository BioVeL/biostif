 ...
 */
public class OauthExampleWithToken {
    ...
    private static String getSignature(String url, String params)
        ...
        String signature = new String(base64.encode(mac.doFinal(base.toString().getBytes(
            ENC))), ENC).trim();
...
//      oauth_version%3D1.0
      ...
      // add it to params list
      qparams1.add(new BasicNameValuePair("oauth_signature", URLEncoder.encode(signature1,ENC)));
...
//      Request vcRequest1 = new Request(Verb.GET, "http://iwgate.poweredbyclear.com:9080/megx.net/ws/v1/verify_credentials/v1.0.0");
//      vcRequest1.getHeaders().put("Authorization", authHeader);
//      
//      org.scribe.model.Response vcResponse1 = vcRequest1.send();
//      System.out.println("res1 status: " + vcResponse1.getCode());    
