 ...
 * @constructor
 */
MapObject = function(name, description, place, lon, lat, weight, tableContent){
 ...
 * @constructor
 */
MapTimeObject = function(name, description, place, lon, lat, timeStart, timeEnd, granularity, weight, tableContent){
