...
I.find(".progress-messages").text("Wird gesendet");
...
I.find(".progress-messages").text("Abgeschlossen");
...
I.find(".progress-messages").text("Beim Versand ist ein Fehler aufgetreten")
}});
return false
});
var K=I.find("#users");
