...
function MapZoomSlider(parent,orientation){
	...
	this.setLanguage = function(language){
		zoomIn.title = STIStatic.getString(language,'zoomIn');
		zoomOut.title = STIStatic.getString(language,'zoomOut');
		this.slider.handle.title = STIStatic.getString(language,'zoomSlider');
	}
