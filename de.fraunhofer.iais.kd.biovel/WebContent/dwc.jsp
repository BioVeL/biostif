...
<title>DwC Converter Input</title>
...
---- Csv2Json -------
<form name="form5" action="<%=request.getContextPath() %>/Csv2Json" enctype="multipart/form-data" method="post">
Input File Location:
</br><input type="file" name="file" id="input5" onclick="clear1()" onChange="write_pathCSV1(this.value)" size=20>
</br> Filename: </br><input type="text" name="fileName" id="input6" size=40> 
</br><input type="submit" value="Upload">
</form>
