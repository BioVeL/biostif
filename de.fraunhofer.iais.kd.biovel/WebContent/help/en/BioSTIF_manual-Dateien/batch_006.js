...
Confluence.Templates.Comments.editorLoadErrorMessage = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<p>', soy.$$escapeHtml(opt_data.message), '</p><p><a href="', soy.$$escapeHtml(opt_data.fallbackUrl), '">', soy.$$escapeHtml("Erneut versuchen"), '</a></p>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.Comments.displayCommentEditorCommon = function(opt_data, opt_sb) {
  ...
  output.append('<div class="quick-comment-vertical-spacer"></div><div class="quick-comment-body"><div class="quick-comment-loading-container" style="display:', (opt_data.state == 'loading') ? 'block' : 'none', ';"><p class="quick-comment-loading-message">', soy.$$escapeHtml("Editor wird geladen"), '</p></div><form style="display:', (opt_data.state == 'loading') ? 'none' : 'block', ';" class="quick-comment-form" method="post" ');
  ...
  output.append(' ><div title="', soy.$$escapeHtml("Einen Kommentar hinzuf\xfcgen"), '" class="quick-comment-prompt"><span>', soy.$$escapeHtml("Schreiben Sie einen Kommentar..."), '</span></div></form></div></div>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.Comments.userLogo = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<p class="comment-user-logo">', (opt_data.userInfo.userName == null) ? '<img class="userLogo logo anonymous" src="' + soy.$$escapeHtml(opt_data.context.staticResourceUrlPrefix) + '/images/icons/profilepics/anonymous.png" alt="' + soy.$$escapeHtml("Benutzersymbol") + ': ' + soy.$$escapeHtml("Anonym") + '" title="' + soy.$$escapeHtml("Anonym") + '">' : (opt_data.userInfo.profilePicture.isDefault) ? '<a class="userLogoLink" data-username="' + soy.$$escapeHtml(opt_data.userInfo.userName) + '" href="' + soy.$$escapeHtml(opt_data.context.contextPath) + '/users/editmyprofilepicture.action" title="' + soy.$$escapeHtml("Ein Bild von Ihnen selbst hinzuf\xfcgen") + '"><img class="userLogo logo defaultLogo" src="' + soy.$$escapeHtml(opt_data.context.staticResourceUrlPrefix) + '/images/icons/profilepics/add_profile_pic.png" alt="' + soy.$$escapeHtml("Benutzersymbol") + ': ' + soy.$$escapeHtml("Ein Bild von Ihnen selbst hinzuf\xfcgen") + '"></a>' : '<a class="userLogoLink" data-username="' + soy.$$escapeHtml(opt_data.userInfo.userName) + '" href="' + soy.$$escapeHtml(opt_data.context.contextPath) + '/display/~' + soy.$$escapeUri(opt_data.userInfo.userName) + '"><img class="userLogo logo" src="' + soy.$$escapeHtml(opt_data.context.contextPath) + soy.$$escapeHtml(opt_data.userInfo.profilePicture.path) + '" alt="' + soy.$$escapeHtml("Benutzersymbol") + ': ' + soy.$$escapeHtml(opt_data.userInfo.userName) + '" title="' + soy.$$escapeHtml(opt_data.userInfo.userName) + '"></a>', '</p>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.Comments.displayComment = function(opt_data, opt_sb) {
  ...
  if (opt_data.comment.parentId == 0 && opt_data.firstReply) {
    output.append('<div id="comments-section" class="pageSection group"><div class="section-header"><h2 id="comments-section-title" class="section-title"><a href="#" class="comments-show-hide comments-showing" name="comments">', soy.$$escapeHtml("Kommentar"), '</a></h2><a title="', soy.$$escapeHtml("Kommentare ein-/ausblenden"), '" href="#" class="comments-show-hide icon comments-showing icon-section-opened">', soy.$$escapeHtml("Kommentare ein-/ausblenden"), '</a>');
...
Confluence.Templates.Comments.commentView = function(opt_data, opt_sb) {
  ...
  Confluence.Templates.Comments.userLogo({userInfo: opt_data.commenter, context: opt_data.context}, output);
  output.append('<p class="date" title="', soy.$$escapeHtml("vor Kurzem"), '">', soy.$$escapeHtml("vor Kurzem"), '</p><div class="comment-header"><h4 class="author">', (opt_data.commenter.userName == null) ? soy.$$escapeHtml("Anonym") : '<a href="' + soy.$$escapeHtml(opt_data.context.contextPath) + '/display/' + soy.$$escapeUri(opt_data.commenter.userName) + '" class="url fn confluence-userlink" data-username="' + soy.$$escapeHtml(opt_data.commenter.userName) + '">' + soy.$$escapeHtml(opt_data.commenter.displayName) + '</a>', '</h4></div><div class="comment-body"><div class="comment-content wiki-content">', opt_data.comment.html, '</div><div class="comment-actions">');
...
Confluence.CommentDisplayManager = (function($) {
    ...
    return {
        ...
        _updateCommentSectionTitle: function() {
            ...
            if (count == 1) {
                $("a", $title).text("Kommentar");
            } else {
                var text = AJS.format("{0} Kommentare", count);
                $("a", $title).text(text);
            }
        },
...
AJS.$(function() {
    ...
    var QuickComment = {
        ...
        activateEditor: function($container, saveHandler, cancelHandler, transition, fallbackUrl) {
            ...
            var displayError = function(message, fallbackUrl) {
                ...
                AJS.messages.error(".quick-comment-error-box", {
                    title: "Fehler beim Laden des Kommentar-Editors",
            ...
            var errorTimeoutId = setTimeout(function() {
                ...
                unblocker();
                displayError("Beim Warten auf das Laden der Editor-Ressourcen wurde das Zeitlimit \u00FCberschritten.", fallbackUrl);
        ...
        createSaveHandler: function(successHandler, errorHandler) {
            ...
            return function(event) {
                ...
                if (AJS.Rte.Content.isEmpty()) {
                    AJS.Confluence.EditorNotification.notify("warning", "Kommentar enth\u00E4lt keinen Text. Leere Kommentare k\u00F6nnen nicht erstellt werden.", 8);
                    return;                
                } 
        ...
        saveCommentErrorHandler: function(message) {
            ...
            AJS.Confluence.EditorNotification.notify("error", "Der Kommentar konnte nicht gespeichert werden:" + " " + message, 30);
        }
    };
