...
Confluence.Templates.Dialog.helpLink = function(opt_data, opt_sb) {
  ...
  Confluence.Templates.Dialog.customHelpLink({href: opt_data.href, text: soy.$$escapeHtml("Hilfe")}, output);
...
Confluence.Templates.PagePermissions.permissionRow = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<tr class="permission-row"><td class="page-permissions-marker-cell" width="20%"><span>', soy.$$escapeHtml("Ansicht beschr\xe4nkt auf:"), '</span></td><td class="permission-entity" nowrap="true" width="40%"><span class="entity-container"><img class="permission-entity-picture"/><span class="permission-entity-display-name"></span><span class="permission-entity-name-wrap">&nbsp;(<span class="permission-entity-name"></span>)</span></span></td><td class="permission-detail-column"><div class="permission-remove-div"><a href="#" class="remove-permission-link">', soy.$$escapeHtml("Beschr\xe4nkung entfernen"), '</a></div></td></tr>');
  return opt_sb ? '' : output.toString();
};

AJS.toInit(function(c){if(!c("link[rel=canonical]").length){return}var b=null;var a=function(){b=new AJS.Dialog(600,210,"link-page-popup").addHeader("Link zu dieser Seite").addPanel("Link zu dieser Seite","<form id='link-page-popup-form' class='aui'><fieldset></fieldset></form>").addCancel("Schlie\u00DFen",function(f){b.hide();return false});if(Confluence.KeyboardShortcuts&&Confluence.KeyboardShortcuts.enabled){b.addHelpText(AJS.format("K\u00FCrzel-Tipp: Das Dialogfeld kann auch durch Dr\u00FCcken auf \u003cb>{0}\u003c\/b> ge\u00F6ffnet werden","k"))}var d=[{label:"Verkn\u00FCpfung",id:"link",value:c("link[rel=canonical]").attr("href")},{label:"Kurzer Link",id:"tiny-link",value:c("link[rel=shortlink]").attr("href")}];c.each(d,function(){c("#link-page-popup-form fieldset").append(AJS.format("<div class='field-group'><label for=''link-popup-field-{0}''>{1}:</label><input id=''link-popup-field-{0}'' readonly=''readonly'' value='''' class=''text'' type=''text''></div>",this.id,this.label)).find("input:last").val(this.value)});var e=c("#link-page-popup-form fieldset input.text");e.focus(function(){c(this).select()});e.mouseup(function(f){f.preventDefault()})};c("#link-to-page-link").click(function(d){if(!b){a()}c(this).parents(".ajs-drop-down")[0].hide();b.show();c("#link-page-popup-form #link-popup-field-tiny-link").select();return AJS.stopEvent(d)})});
...
Confluence.Templates.ManageWatchers.dialogContent = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<div class="dialog-content"><div class="column page-watchers"><h3>', soy.$$escapeHtml("Diese Seite beobachten"), '</h3><p class="description">', soy.$$escapeHtml("Diese Benutzer werden benachrichtigt, wenn \xc4nderungen an der Seite vorgenommen werden. Sie k\xf6nnen Personen zu der Liste hinzuf\xfcgen oder aus der Liste entfernen."), '</p><form action="', soy.$$escapeHtml(""), '/json/addwatch.action" method="POST"><input type="hidden" name="atl_token" value="', soy.$$escapeHtml(opt_data.xsrfToken), '"><input type="hidden" name="pageId" value="', soy.$$escapeHtml(opt_data.pageId), '"/><input type="hidden" id="add-watcher-username" name="username" value=""/><label for="add-watcher-user">', soy.$$escapeHtml("Benutzer"), '</label><input id="add-watcher-user" name="userFullName" type="search" class="autocomplete-user" value="" placeholder="', soy.$$escapeHtml("Benutzername oder E-Mail"), '" autocomplete="off" data-max="10" data-target="#add-watcher-username" data-dropdown-target="#add-watcher-dropdown" data-template="{title}" data-none-message="', soy.$$escapeHtml("Keine entsprechenden Benutzer gefunden"), '"><input id="add-watcher-submit" type="submit" name="add" value="', soy.$$escapeHtml("Hinzuf\xfcgen"), '"><div id="add-watcher-dropdown" class="aui-dd-parent autocomplete"></div><div class="status hidden"></div></form><ul class="user-list"><li class="loading">', "Laden\x26hellip;", '</li><li class="no-users hidden">', soy.$$escapeHtml("Keine Seitenbeobachter"), '</li></ul></div><div class="column space-watchers"><h3>', soy.$$escapeHtml("Diesen Bereich beobachten"), '</h3><p class="description">', soy.$$escapeHtml("Diese Benutzer werden benachrichtigt, wenn Inhalt in diesem Bereich ge\xe4ndert wird. Sie k\xf6nnen diese Liste nicht bearbeiten."), '</p><ul class="user-list"><li class="loading">', "Laden\x26hellip;", '</li><li class="no-users hidden">', soy.$$escapeHtml("Keine Bereichbeobachter"), '</li></ul></div></div>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.MovePage.breadcrumbLoading = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<li class="loading"><span>', "Breadcrumbs\x26hellip; werden geladen", '</span></li>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.MovePage.breadcrumbError = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<li class="warning last"><span>', soy.$$escapeHtml("Fehler beim Abrufen der Breadcrumbs."), '</span></li>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.MovePage.noMatchingPages = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<ol><li><span class="warning">', soy.$$escapeHtml("Es wurden keine \xfcbereinstimmenden Seiten gefunden."), '</span></li></ol>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.MovePage.noMatchingSpaces = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<ol><li><span class="warning">', soy.$$escapeHtml("Es wurden keine \xfcbereinstimmenden Bereiche gefunden."), '</span></li></ol>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.MovePage.searchResultsLoading = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<div class="searching">', soy.$$escapeHtml("Suche l\xe4uft\u2026"), '</div>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.MovePage.pageHistoryLoading = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<div class="searching">', soy.$$escapeHtml("Wird geladen..."), '</div>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.MovePage.panelLoading = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<span>', soy.$$escapeHtml("Wird geladen..."), '</span>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.MovePage.reorderCheckbox = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<span id="reorderRequirement"><input id="reorderCheck" type="checkbox" name="reorderFlag" title="', soy.$$escapeHtml("W\xe4hlen Sie den Speicherort Ihrer Seite oben im Bereich aus."), '"/><label for="reorderCheck" title="', soy.$$escapeHtml("W\xe4hlen Sie den Speicherort Ihrer Seite oben im Bereich aus."), '">', soy.$$escapeHtml("Neu sortieren"), '</label></span>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.MovePage.historyPanel = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<div class="row information"><div class="inner"><div class="element">', soy.$$escapeHtml(AJS.format("W\xe4hlen Sie die neue \xfcbergeordnete Seite f\xfcr diese Seite und ihre untergeordneten Seiten aus ihrer Historie aus.",opt_data.pageTitle)), '</div></div></div><div id="move-page-search-container" class="row"><div class="search-results"></div></div>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.MovePage.browsePanel = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<div class="row information"><div class="inner"><div class="element">', soy.$$escapeHtml(AJS.format("Sie k\xf6nnen die markierte Seite verschieben, indem Sie sie in eine neue Position in der Hierarchie ziehen.",opt_data.pageTitle)), '</div></div></div><div class="tree"></div>');
  return opt_sb ? '' : output.toString();
};
...
AJS.toInit(function(e){Confluence.MovePageDialog=function(h){var l=AJS.Meta.get("page-title");h=e.extend({spaceKey:AJS.Meta.get("space-key"),spaceName:AJS.Meta.get("space-name"),pageTitle:l,parentPageTitle:AJS.Meta.get("parent-page-title"),title:AJS.format("Seite verschieben &ndash; &#8216;{0}&#8217;",l),buttonName:"Verschieben",openedPanel:"Erweitert",moveHandler:function(z){AJS.log("No move handler defined. Closing dialog.");z.remove()},cancelHandler:function(z){z.remove();return false}},h);var r={spaceKey:h.spaceKey,spaceName:h.spaceName,parentPageTitle:h.parentPageTitle};var g=h.spaceKey;var t=h.spaceName;var w=h.parentPageTitle;var i="";var m="";var k=function(z,A){i=z;m=A};var x=AJS.ConfluenceDialog({width:800,height:590,id:"move-page-dialog"});x.addHeader(h.title);x.addPanel("Erweitert",AJS.renderTemplate("movePageDialog"),"location-panel","location-panel-id");x.addPanel("Suchen",AJS.renderTemplate("movePageSearchPanel"),"search-panel","search-panel-id");x.addPanel("K\u00FCrzlich angezeigt",Confluence.Templates.MovePage.historyPanel({pageTitle:AJS.Meta.get("page-title")}),"history-panel","history-panel-id");x.addPanel("Durchsuchen",Confluence.Templates.MovePage.browsePanel({pageTitle:AJS.Meta.get("page-title")}),"browse-panel","browse-panel-id");x.get('#"'+"Erweitert"+'"')[0].onselect=function(){e("#new-space-key").val(g);e("#new-space").val(t);e("#new-parent-page").val(w).select()};x.get('#"'+"Suchen"+'"')[0].onselect=function(){e("#move-page-dialog .search-panel .search-results .selected").removeClass("selected");e("#move-page-dialog input.search-query").focus()};x.get('#"'+"K\u00FCrzlich angezeigt"+'"')[0].onselect=function(){e(".history-panel",u).movePageHistory(o)};x.get('#"'+"Durchsuchen"+'"')[0].onselect=function(){AJS.log("browse: "+[g,t,w].join());e(".browse-panel",u).movePageBrowse(o,g,t,w,n,h.pageTitle)};var s=function(A){A.nextPage();var z=e("#move-page-dialog");e(".ordering-panel",z).movePageOrdering(g,w,h.pageTitle,k)};var q=function(A){var C=e("#new-space:visible").val();var B=e("#new-space-key").val();var z=e("#new-parent-page:visible").val();if(C&&(C!=t||B!=g||z!=w)){AJS.MoveDialog.getBreadcrumbs({spaceKey:B,pageTitle:z},function(){Confluence.PageLocation.set({spaceKey:B,spaceName:C,parentPageTitle:z});h.moveHandler(A,B,C,z,i,m,f)},function(D){e("#new-parent-breadcrumbs").html(Confluence.Templates.MovePage.breadcrumbError());if(D.status==404){o.error("Die angegebene Seite wurde nicht gefunden.")}})}else{Confluence.PageLocation.set({spaceKey:g,spaceName:t,parentPageTitle:w});h.moveHandler(A,g,t,w,i,m,f)}};var y=function(z){if(e("#reorderCheck")[0].checked){s(z)}else{q(z)}};x.addButton(h.buttonName,y,"move-button");x.addCancel("Abbrechen",h.cancelHandler);x.popup.element.find(".dialog-title").append(Confluence.Templates.MovePage.helpLink());x.addPage().addHeader(h.title).addPanel("Seitensortierung",Confluence.Templates.MovePage.orderingPagePanel(),"ordering-panel","ordering-panel-id").addLink("Zur\u00FCck",function(z){z.prevPage()},"dialog-back-link").addButton("Neu sortieren",q,"reorder-button").addCancel("Abbrechen",h.cancelHandler);var v=x.get("button#"+h.buttonName)[0].item;e("button.move-button").before(Confluence.Templates.MovePage.reorderCheckbox());x.gotoPage(0);x.show();var u=e("#move-page-dialog");e(".location-panel .location-info",u).appendTo(e(".dialog-page-body:first",u));e(".dialog-button-panel:visible",u).prepend(Confluence.Templates.MovePage.errorMessage());var j=new AJS.MoveDialog.Breadcrumbs(e("#new-parent-breadcrumbs"));function f(z){if(!z||z.length==0){e("#move-errors").addClass("hidden");e(v).prop("disabled",false);return}if(!e.isArray(z)){z=[z]}e("#move-errors").text(z[0]).attr("title",z.join("\n")).removeClass("hidden");x.gotoPage(0)}var o={moveButton:v,clearErrors:function(){f([])},error:f,select:function(B,A,z){AJS.log("select: "+[B,A,z].join());g=B;t=A;w=z||"";e(v).prop("disabled",true);j.update({spaceKey:g,title:w},o)}};x.overrideLastTab();x.get('#"'+h.openedPanel+'"').select();var n=AJS.Meta.get("parent-page-title")||AJS.Meta.get("from-page-title");var p=new AJS.MoveDialog.Breadcrumbs(e("#current-parent-breadcrumbs"));p.update({spaceKey:AJS.Meta.get("space-key"),title:n},o);e(".location-panel",u).movePageLocation(o);e(".search-panel",u).movePageSearch(o);e(".history-panel",u).movePageHistory(o);e("#new-parent-page").select();if(h.hint){x.addHelpText(h.hint.template||h.hint.text,h.hint.arguments)}return u};var d=function(h,g,i,f){var j={pageId:AJS.params.pageId,spaceKey:h};if(i){j.position=f;j.targetId=i}else{if(g!=""){j.targetTitle=g;j.position="append"}else{j.position="topLevel"}}return j};function a(j,l,f,m,o,g,i){j=j.popup.element;j.addClass("waiting");e("button",j).prop("disabled",true);var h=e("<div class='throbber'></div>");j.append(h);var n=Raphael.spinner(h[0],100,"#666");function k(p){i(p);j.removeClass("waiting");n();e("button",j).prop("disabled",false)}e.ajax({url:contextPath+"/pages/movepage.action",type:"GET",dataType:"json",data:new d(l,m,o,g),error:function(){k("Fehler beim Verschieben. Beim Herstellen der Verbindung mit dem Server ist ein Problem aufgetreten.")},success:function(p){var q=[].concat(p.validationErrors||[]).concat(p.actionErrors||[]).concat(p.errorMessage||[]);if(q.length>0){k(q);return}window.location.href=contextPath+p.page.url+(p.page.url.indexOf("?")>=0?"&":"?")+"moved=true"}})}e("#action-move-page-dialog-link").click(function(f){f.preventDefault();if(e("#move-page-dialog").length>0){e("#move-page-dialog, body > .shadow, body > .aui-blanket").remove()}new Confluence.MovePageDialog({moveHandler:a});return false});var c;e("#rte-button-location").click(function(f){f.preventDefault();if(e("#move-page-dialog").length>0){e("#move-page-dialog, body > .shadow, body > .aui-blanket").remove()}new Confluence.MovePageDialog({spaceName:c,spaceKey:e("#newSpaceKey").val(),pageTitle:e("#content-title").val(),parentPageTitle:e("#parentPageString").val(),buttonName:"Verschieben",title:"Speicherort der Seite einstellen",moveHandler:function(k,h,l,m,j,i,g){c=l;e("#newSpaceKey").val(h);e("#parentPageString").val(m);if(m!=""){e("#position").val("append")}else{e("#position").val("topLevel")}if(j){e("#targetId").val(j);e("#position").val(i)}k.remove()}});return false});var b=null;Confluence.PageLocation={get:function(){if(b){return b}return{spaceName:AJS.Meta.get("space-name"),spaceKey:AJS.Meta.get("space-key"),parentPageTitle:AJS.Meta.get("parent-page-title")}},set:function(f){b=f}}});
...
Confluence.Templates.CreateSpace.createSpaceForm = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<p>', soy.$$escapeHtml("Bereich f\xfcr Ihr Team bzw. Projekt erstellen:"), '</p><form action="', soy.$$escapeHtml(""), '/spaces/createspace.action" method="post" class="aui" id="create-space-form"><fieldset><div class="field-group"><label for="name">', soy.$$escapeHtml("Bereichsname"), '</label><input class="medium-field" name="name" autocomplete="off" ', (opt_data.name) ? 'value="' + soy.$$escapeHtml(opt_data.name) + '"' : '', '/>');
  ...
  output.append('</div><div class="field-group"><label for="key">', soy.$$escapeHtml("Bereichsschl\xfcssel"), '</label><input class="medium-field" name="key" ', (opt_data.key) ? 'value="' + soy.$$escapeHtml(opt_data.key) + '"' : '', '/><div class="description">', AJS.format("Wird in der URL: {0} des Bereichs verwendet",'<br /><span id="space-url-example"></span>'), '</div>');
...
Confluence.Templates.CreateSpace.createPersonalSpaceForm = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<form action="', soy.$$escapeHtml(""), '/spaces/docreatepersonalspace.action" method="post" class="aui" id="create-personal-space-form"><p>', "Der Pers\xf6nliche Bereich ist Ihr eigener privater Bereich innerhalb von Confluence. Sie k\xf6nnen den pers\xf6nlichen Bereich optional zum lesen freigeben.\n", '</p>');
  Confluence.Templates.CreateSpace.spaceFormPermissions(opt_data, output);
  output.append('<input type="hidden" name="atl_token" value="', soy.$$escapeHtml(opt_data.atlToken), '" />');
  if (opt_data.buttons) {
    Confluence.Templates.CreateSpace.spaceFormButtons(null, output);
...
Confluence.Templates.CreateSpace.spaceFormPermissions = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<fieldset class="group" id="permissions-group"><div class="checkbox ', (opt_data.spacePermission == 'private') ? 'locked' : '', '"><input class="checkbox" type="checkbox" id="permission-private" name="spacePermission" value="private"', (opt_data.spacePermission == 'private') ? ' checked="checked"' : '', ' /><label for="permission-private">', soy.$$escapeHtml("Diesen Bereich privat machen"), '</label></div></fieldset>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.CreateSpace.spaceFormButtons = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<div class="buttons-container"><div class="buttons"><input name="create" class="button button-panel-submit-button" type="submit" value="', soy.$$escapeHtml("Erstellen"), '" /><a href="', soy.$$escapeHtml(""), '/dashboard.action">', soy.$$escapeHtml("Abbrechen"), '</a></div></div>');
  return opt_sb ? '' : output.toString();
};

AJS.toInit(function(e){var l=null,q,d,o,r,n,j=false,p,c=100;var i={key:function(){var t=e.Deferred();var u=e.trim(q.val());if(!u){t.reject("Sie m\u00FCssen einen Bereichsschl\u00FCssel eintragen.");return t}if(p){AJS.log("Aborting previous space key validation request.");p.abort()}p=e.getJSON(AJS.Confluence.getContextPath()+"/ajax/spaceavailable.action",{key:u}).done(function(v){if(!v.available&&v.message){t.reject(v.message)}else{t.resolve()}p=false});return t.promise()},name:function(){var t=e.Deferred();if(!e.trim(d.val())){t.reject("Sie m\u00FCssen einen Bereichsnamen eingeben.")}else{t.resolve()}return t.promise()}};function m(w){var v=w[0];if(v.setSelectionRange){var u=w.val().length;v.setSelectionRange(0,u)}else{if(v.createTextRange){var t=v.createTextRange();t.execCommand("SelectAll");t.select()}}}function h(t){if(t){o.removeAttr("disabled")}else{o.attr("disabled","disabled")}j=t}var s={};function b(v){h(false);var t=v.attr("name");var u=v.siblings(".error");s[t]=true;var w=i[t]();w.done(function(){delete s[t];u.text("").addClass("hidden")});w.fail(function(x){u.text(x).removeClass("hidden")});w.always(function(){h(e.isEmptyObject(s))});return w}function a(t){var x=t.find("#space-url-example"),u=AJS.Meta.get("base-url")+"/display/",v="<"+"BEREICHSSCHL\u00DCSSEL"+">",z=function(B){B=B||v;var A=u+B;x.text(A)},w=false;h(false);z();q=t.find("input[name='key']").first();d=t.find("input[name='name']").first();r=q.parent().find(".error");n=d.parent().find(".error");q.generateFrom(d,{uppercase:false,maxNameLength:255,maxKeyLength:255,timeoutMS:c,validationCallback:function(){q.keyup()}});function y(){var B=e(this);var A=B.val();if(typeof B.data("originalVal")==="undefined"){B.data("originalVal","")}if(B.data("originalVal")===A){return}B.data("originalVal",A);b(B)}q.keyup(e.debounce(y,500));d.keyup(y);q.keyup(function(){z(q.val())});q.focus(function(){m(q)});t.find("#permission-private").change(function(){e(this).parent().toggleClass("locked")});t.submit(function(A){if(!w){A.preventDefault()}else{return}setTimeout(function(){var C=b(q);var B=b(d);e.when({},C,B).then(function(){if(j){w=true;t.submit()}})},c+1)})}function f(){var u=e(Confluence.Templates.CreateSpace.createSpaceForm({atlToken:e("#atlassian-token").prop("content")})),t=function(){u.submit()},v=function(){w.hide();d.val("");q.val("");r.text("").addClass("hidden");n.text("").addClass("hidden");h(false)},w=new AJS.ConfluenceDialog({width:540,height:340,id:"create-space-dialog",closeOnOutsideClick:true,onCancel:v,onSubmit:t});w.addHeader("Bereich erstellen");w.addPanel("Panel 1",u);w.addSubmit("Erstellen",t);w.addCancel("Abbrechen",v);o=w.popup.element.find(".button-panel-submit-button");a(u);w.gotoPage(0);w.gotoPanel(0);return w}function g(t){t&&t.preventDefault();if(!l){l=f()}l.show()}AJS.bind("ready-for-create-space-form-init",function(u,t){o=t.find("input[type=submit]");a(t)});e('a[href="'+AJS.contextPath()+'/spaces/createspace-start.action"]').click(g);var k=e("#create-space-form:not(.noautobind)");if(k.length){AJS.trigger("ready-for-create-space-form-init",[k])}});
AJS.toInit(function(d){var c=null,b=function(){var f=d(Confluence.Templates.CreateSpace.createPersonalSpaceForm({atlToken:d("#atlassian-token").prop("content")})),e=function(){f.submit()},g=new AJS.ConfluenceDialog({width:540,height:300,id:"create-personal-space-dialog",closeOnOutsideClick:true,onSubmit:e});g.addHeader("F\u00FCgen Sie Ihren pers\u00F6nlichen Bereich hinzu.");g.addPanel("Panel 1",f);g.addSubmit("Erstellen",e);g.addCancel("Abbrechen",function(){g.hide()});g.gotoPage(0);g.gotoPanel(0);return g},a=function(){if(c==null){c=b()}c.show();d("#create-personal-space-dialog button.button-panel-submit-button").focus()};d("#create-personal-space-link").click(function(){a();return false})});
...
AJS.toInit(function ($) {
    ...
    createDialog = function (isShownForUser) {
        ...
        var headingPattern = "Was ist neu in Confluence {0}";
        ...
        dialog.addCancel("Schlie\u00DFen", function () {
            dialog.hide().remove();
            timeout && clearTimeout(timeout);
            return false;
        });
...
Confluence.KeyboardShortcuts.getDialog = function () {
    ...
    makeEditorShortcutsMenu = function() {
        ...
        editorShortcutsMenu.append(makeShortcutModule("Block-Formatierung", ["tinymce.block"], shortcuts));
        editorShortcutsMenu.append(makeShortcutModule("Umfangreiche Formatierung", ["tinymce.rich"], shortcuts));
        editorShortcutsMenu.append(makeShortcutModule("Bearbeitungsaktionen", ["tinymce.actions"], shortcuts));
...
AJS.toInit(function($) {
    ...
    AJS.bind("keyboard-shortcut-dialog-ready", function(e, popup) {
        popup.addPanel("Editor-Autoformatierung", buildHelpPanel());
    });
    ...
    Confluence.KeyboardShortcuts.Autoformat = [
        ...
        },
        {
            ...
            action: "h1. \u00DCberschrift"
        },
        {
            context: "autoformat.styles",
            description: templates.h3Description(),
            action: "h3. \u00DCberschrift"
        },
        {
            context: "autoformat.styles",
...
Confluence.Templates.KeyboardShortcutsDialog.Autoformat.configureAutocomplete = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<div id="keyboard-shortcut-autocomplete-message">', soy.$$escapeHtml("Zum Konfigurieren von AutoVervollst\xe4ndigen"), ' <a target="_blank" href=', soy.$$escapeHtml(opt_data.href), '>', soy.$$escapeHtml("gehen Sie zu Ihren Editor-Einstellungen"), '</a></div>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.KeyboardShortcutsDialog.Autoformat.boldDescription = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<b>', soy.$$escapeHtml("Fett"), '</b> ', soy.$$escapeHtml("Text"));
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.KeyboardShortcutsDialog.Autoformat.underlineDescription = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<span style="text-decoration: underline;">', soy.$$escapeHtml("Unterstreichen"), '</span> ', soy.$$escapeHtml("Text"));
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.KeyboardShortcutsDialog.Autoformat.italicDescription = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<em>', soy.$$escapeHtml("Kursiv"), '</em> ', soy.$$escapeHtml("Text"));
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.KeyboardShortcutsDialog.Autoformat.monospaceDescription = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<code>', soy.$$escapeHtml("Festbreitenschriftart"), '</code> ', soy.$$escapeHtml("Text"));
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.KeyboardShortcutsDialog.Autoformat.tableDescription = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<table class="confluenceTable"><tbody><tr><td class="confluenceTd">', soy.$$escapeHtml("erste Zelle"), '</td><td class="confluenceTd">&nbsp;</td><td class="confluenceTd">&nbsp;</td><td class="confluenceTd">&nbsp;</td></tr></tbody></table>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.KeyboardShortcutsDialog.Autoformat.tableWithHeadingsDiscriptions = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<table class="confluenceTable"><tbody><tr><th class="confluenceTh">', soy.$$escapeHtml("\xdcberschrift"), '</th><th class="confluenceTh">', soy.$$escapeHtml("\xdcberschrift"), '</th></tr><tr><td class="confluenceTd">&#8203;</td><td class="confluenceTd">&#8203;</td></tr></tbody></table>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.KeyboardShortcutsDialog.Autoformat.h1Description = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<h1>', soy.$$escapeHtml("\xdcberschrift"), '</h1>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.KeyboardShortcutsDialog.Autoformat.h3Description = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<h3>', soy.$$escapeHtml("\xdcberschrift"), '</h3>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.KeyboardShortcutsDialog.Autoformat.bqDescription = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<blockquote>', soy.$$escapeHtml("Zitat"), '</blockquote>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.KeyboardShortcutsDialog.Autoformat.numberedListDescription = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<ol><li>', soy.$$escapeHtml("Liste"), '</li></ol>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.KeyboardShortcutsDialog.Autoformat.bulletedListDescription = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<ul><li>', soy.$$escapeHtml("Aufz\xe4hlungszeichen"), '</li></ul>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.KeyboardShortcutsDialog.keyboardShortcutHelpLink = function(opt_data, opt_sb) {
  ...
  Confluence.Templates.Dialog.customHelpLink({href: soy.$$escapeHtml("http://docs.atlassian.com/confluence/docs-43/Keyboard+Shortcuts"), text: soy.$$escapeHtml("Alle K\xfcrzel")}, output);
  output.append('</div>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.KeyboardShortcutsDialog.keyboardShortcutEnabledCheckbox = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<form name="shortcut-settings" id="shortcut-settings-form"><input type="checkbox" name="enabled" id="keyboard-shortcut-enabled-checkbox"><label for="keyboard-shortcut-enabled-checkbox">', soy.$$escapeHtml("Allgemeine K\xfcrzel aktivieren"), '</label></form>');
  return opt_sb ? '' : output.toString();
};
